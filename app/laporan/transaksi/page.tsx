// app/laporan/transaksi/page.tsx
"use client";
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white p-6 shadow rounded-lg">
      <div className="flex justify-between mb-6">
        <div>
          <p className="text-sm font-semibold text-gray-500 uppercase tracking-[0.2em]">Laporan</p>
          <h1 className="text-3xl font-bold">Rekap Transaksi</h1>
        </div>

        <div className="flex gap-3">
          <button onClick={() => applyFilter("all")} className="px-3 py-2 bg-gray-200 rounded">
            Semua
          </button>
          <button onClick={() => applyFilter(3)} className="px-3 py-2 bg-gray-200 rounded">
            3 Hari
          </button>
          <button onClick={() => applyFilter(7)} className="px-3 py-2 bg-gray-200 rounded">
            7 Hari
          </button>
          <button onClick={() => applyFilter(14)} className="px-3 py-2 bg-gray-200 rounded">
            14 Hari
          </button>
        </div>
      </div>
